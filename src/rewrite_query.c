...
bool rewrite_query(PgSocket *client, PktHdr *pkt) {
	...
	tmp_new_query_str = pycall(client, client->auth_user->name, query_str, (long int)client->xact_start, (long int)client->query_start, cf_rewrite_query_py_module_file,
			"rewrite_query");
